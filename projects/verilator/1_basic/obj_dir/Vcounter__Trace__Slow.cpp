...
void Vcounter::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"o_cnt", false,-1, 3,0);
        tracep->declBus(c+4,"counter num", false,-1, 31,0);
        tracep->declBit(c+1,"counter clk", false,-1);
        tracep->declBit(c+2,"counter rstn", false,-1);
        tracep->declBus(c+3,"counter o_cnt", false,-1, 3,0);
    }
}
...
void Vcounter::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+2,(vlTOPp->rstn));
        tracep->fullCData(oldp+3,(vlTOPp->o_cnt),4);
